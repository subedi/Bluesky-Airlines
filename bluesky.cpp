...
cout <<"\n Option :: ";
	...
	{
	case 1: bluesky.make_reservation();
					break;
	case 2: bluesky.cancel_reservation();
					break;	
	case 3: bluesky.search_passenger();
					break;
	case 4: bluesky.change_reservation();
					break;
	case 5: bluesky.print_list();
					break;
	case 6: bluesky.print_report();
					break;
	case 7: cout << "\n\nGOOD BYE DEAR USER. HAVE A BLAST!!!\n\n\n"; 
					break;
